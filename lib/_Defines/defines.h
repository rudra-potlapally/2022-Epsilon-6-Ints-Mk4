...
#define ORBIT_FAR_SPEED 50
#define ORBIT_STRIKE_SPEED 60

//--------- COMPASS ---------//

#define COMPASS_P (ROBOT == 1 ? 0.55 : 0.55)
#define COMPASS_I 0.0
#define COMPASS_D (ROBOT == 1 ? 0.11 : 0.11)

#define SIDEWAY_P (ROBOT == 1 ? 0.4 : 0.6)
#define SIDEWAY_I 0.0
#define SIDEWAY_D (ROBOT == 1 ? 0.01 : 0.01)

#define yup_P (ROBOT == 1 ? 1.0 : 1.0)
#define yup_I 0.0
#define yup_D (ROBOT == 1 ? 0.08 : 0.08)

#define defend_P (ROBOT == 1 ? 0.1 : 0.15)
#define defend_I 0.0
#define defend_D (ROBOT == 1 ? 0.005 : 0.01)

#define attack_P (ROBOT == 1 ? 0.2 : 0.2)
#define attack_I 0.0
#define attack_D (ROBOT == 1 ? 0.0 : 0.0)

//----------LIGHT SENSORS ----------------//

#define LS_NUM 32
#define LS_NUM_IND 16
#define LINE_BUFFER (ROBOT == 1 ? 900 : 300)
#define LS_AVOID_MEDIUM (ROBOT == 1 ? 160  : 160 )
#define LS_AVOID_FAST (ROBOT == 1 ? 180  : 180)
...
#define BALL_CLOSE_STRENGTH (ROBOT == 1 ? 135 : 130)
...
#define DEFENSE_SURGE_STRENGTH (ROBOT == 1 ? 142 : 135)
